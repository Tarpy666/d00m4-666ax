# D00M4-666AX — Build Plan (next agent brief)

**Genre:** first-person-shooter · **Era inspiration:** 1993 · **Target engine:** three-js
...
(D00M4-666AX). Mechanics are genre conventions; nothing is cloned — no code,
...
3. Depth loop (procedural variety, moddable rules) — modules: RaycastStep, WaveDirector.
